...
var ServService = /** @class */ (function () {
    function ServService(storage) {
        this.storage = storage;
    }
    ServService.prototype.getSomenteLer = function () {
        return this._somenteLer;
    };
    ServService.prototype.setSomenteLer = function (somenteLer) {
        this._somenteLer = somenteLer;
    };
    ServService.prototype.GuardarId = function (id) {
        this.storage.set('id', id);
    };
    ServService.prototype.PegarId = function () {
        var _this = this;
    ...
    ServService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/services/mascara.service.ts":
/*!*********************************************!*\
  !*** ./src/app/services/mascara.service.ts ***!
  \*********************************************/
/*! exports provided: MascaraService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MascaraService", function() { return MascaraService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MascaraService = /** @class */ (function () {
    function MascaraService(modalCtrl, alertCtrl, menu, navCtrl, t) {
    ...
    MascaraService.prototype.ionViewDidEnter = function () {
        this.menu.swipeEnable(false);
    };
    MascaraService.prototype.ionViewWillLeave = function () {
        this.menu.swipeEnable(true);
    };
    MascaraService.prototype.format = function (valString, formato) {
    ...
    ;
    MascaraService.prototype.unFormat = function (val) {
        if (!val) {
            return '';
        }
        val = val.replace(/\D/g, '');
    ...
    ;
    MascaraService.prototype.cpf_mask = function (v) {
    ...
    MascaraService.prototype.cep_mask = function (v) {
        v = v.replace(/\D/g, ''); //Remove tudo o que não é dígito
        v = v.replace(/(\d{5})(\d{1,3})$/, '$1-$2'); //Coloca um hífen entre o terceiro e o quarto dígitos
        return v;
    };
    MascaraService.prototype.cnpj = function (v) {
        v = v.replace(/\D/g, ''); //Remove tudo o que não é dígito
    ...
    MascaraService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
